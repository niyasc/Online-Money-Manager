<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
    	...
    	{
    		render("add_expense.php",["title"=>"Add Record","error"=>"Please fill all entries","categories"=>$categories]);
    	}
    	else if(!is_valid_date($_POST["date"]))
    	{
    		render("add_expense.php",["title"=>"Add Record","error"=>"Invalid Date format","categories"=>$categories]);
    	}
    	else 
    	{
    		...
    		render("add_expense.php",["title"=>"Add Record","message"=>"Value added successfully","categories"=>$categories]);
    	}
    }
    else
    {
